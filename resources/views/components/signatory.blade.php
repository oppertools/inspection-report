@props(['signatory' => null, 'type' => null, 'name' => null, 'index' => null, 'hasSignature' => false, 'date' => null])
...
<div class="flex flex-col gap-3 break-inside-avoid">
    ...
    <div class="flex flex-col gap-1 items-start justify-start text-left">
        @if ($hasSignature && $signatory->signatureWithIndex($index) && file_exists($signatory->signatureWithIndex($index)))
